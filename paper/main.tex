...
\pagebreak % TODO remove? temporary for avoiding orphan
...
\begin{proof}
%  TODO transcribe from paper. 
%  Base, Proj, and Unroll cases immediate by inversion and induction.
%  Deown/ref cases use read safety and read uniqueness as well.
...
\begin{proof}
  TODO transcribe from paper. Base, Proj, and Unroll cases are trivial.
  Deown/ref cases use a chain of preservation lemmas (path type, read safety, path shape).
\end{proof}
