...
\fbox{$\sev{V}{H}{s}{V'}{H'}{s'}$}

\begin{mathpar}
  \infer[SE-SKIPSEQ]{ }{\sev{V}{H}{\seq{\nop}{s}}{V}{H}{s}} \and
  \infer[SE-STEPSEQ]
    {\sev{V}{H}{s_1}{V'}{H'}{s'_1}}
    {\sev{V}{H}{\seq{s_1}{s_2}}{V'}{H'}{\seq{s'_1}{s_2}}} \and
  \infer[SE-SET]
    {\ev{V;H_0}{e}{l;H_1} \\
     \ev{V;H_1}{\lv{x}{p}}{\ga} \\
     \textsc{write}(H_1,\ga,l,H_2)
    }
    {\sev{V}{H_0}{\set{\lv{x}{p}}{e}}{V}{H_2}{\nop}} \and
  \infer[SE-NEW]
    {\ev{V;H_0}{\lv{x_r}{p_r}}{\ga_r} \\
     \Read{H_0}{\ga_r}{l_r} \\
     \textsc{write}(H_0,\ga_r,\textsc{use}(l_r),H_1) \\\\
     \ev{V;H_1}{\lv{x_l}{p_l}}{\ga_l} \\
     \textsc{fresh}(\ga_n) \\
     \textsc{write}(H_1,\ga_l,\own{\ga_n},H_2) \\
    }
    {\sev{V}{H_0}{\new{\lv{x_l}{p_l}}{\lv{x_r}{p_r}}}{V}{H_2, \ga_n\mapsto l_r}{\nop}} \and
  \infer[SE-SWAP]
    {\ev{V;H_0}{\lv{x_l}{p_l}}{\ga_l} \\
     \ev{V;H_0}{\lv{x_r}{p_r}}{\ga_r} \\\\
     \Read{H_0}{\ga_l}{l_l} \\
     \Read{H_0}{\ga_r}{l_r} \\\\
     \textsc{write}(H_0,\ga_l,l_r,H_1) \\
     \textsc{write}(H_1,\ga_r,l_l,H_2)
    }
    {\sev{V}{H_0}{\swap{\lv{x_l}{p_l}}{\lv{x_r}{p_r}}}{V}{H_2}{\nop}} \and
  \infer[SE-FREE]
    {\ev{V;H_0}{\lv{x}{p}}{\ga} \\
     \Read{H_0}{\ga}{\own{\ga'}} \\
     \textsc{write}(H_0,\ga,\textsc{use}(\own{\ga'}),H_1)
    }
    {\sev{V}{H_0}{\free{\lv{x}{p}}}{V}{H_1|_{\dom H_1 - \{\ga'\}}}{\nop}} \and
  \infer[SE-PUSH]
    {\textsc{fresh}(\ga)}
    {\sev{V}{H}{\push{\lt}{x}{\gt}{s}}{V,x\mapsto\ga}{H,\ga\mapsto\void}{\pop{x}{s}}} \and
  \infer[SE-POPSTEP]
    {\sev{V}{H}{s}{V'}{H'}{s'}}
    {\sev{V}{H}{\pop{x}{s}}{V'}{H'}{\pop{x}{s'}}} \and
  \infer[SE-POPSKIP]
    { }
    {\sev{V}{H}{\pop{x}{\nop}}{V|_{\dom V - \{x\}}}{H|_{\dom H - \{V(x)\}}}{\nop}}
\end{mathpar}

\subsection*{Statement Preservation}
Statement preservation is the assertion that given all our well-formed contexts,
a well-typed statement, and the fact that that statement evaluates to another statement,
then we can also type the result statement and both statements produce the same output
shadow heap, i.e.\ they effectively end in the same way.
Put another way, this lemma asserts that memory safe programs step to memory safe programs.

It is difficult to specify how the new versions of contexts relate to the old versions.
...
\begin{conj}[Statement Preservation]
  \raggedright
