...
\begin{verbatim}
{
  ...
  // x is initialized, by *x and **x are not
...
%{\textsc{init}(H,\own{\addr{\ga}{r}})}
%\and
%\infer[I-REF]
%{\Read{H}{\addr{\ga}{r}}{l} \\ \textsc{init}(H,l)}
%{\textsc{init}(H,\refval{q}{\addr{\ga}{r}})}
%\and
%\infer[I-VAR]
%{\textsc{init}(H,c) \\ \textsc{init}(H,l)}
%{\textsc{init}(H,\varval{c}{l})}
%\and
%\infer[I-REC]
%{\forall i.~\textsc{init}(H,l_i)}
%{\textsc{init}(H,\subrec{l}{i}{n})}
%\and
%\infer[I-ROLL]
%{\textsc{init}(H,l)}
%{\textsc{init}(H,\roll{\gt}{l})}
%\end{mathpar}
